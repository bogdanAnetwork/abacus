...
import abacus.project.ietf.flexiGrid.mediaChannel.LinkChannelAttributes;
...
public class LinkChannelListType implements Serializable {
  ...
  @JsonCreator
  public LinkChannelListType (
    @JsonProperty("link-id") String linkId,
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), linkId, n, m, sourceNode, sourcePort, destinationNode, destinationPort, link, bidirectional);
  }
  ...
  public boolean equals(Object o) {
    ...
    LinkChannelListType that = (LinkChannelListType) o;
